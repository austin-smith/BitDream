...
final class SampleTransmissionServerTests: XCTestCase {
    ...
    func testLibraryLoadsThroughRealRPCAndMatchesDetailsAndWidget() async throws {
        ...
        XCTAssertEqual(snapshot.polling.sessionStats.downloadSpeed, 14_964_000)
    ...
    func testTransferTotalsAndRatiosMatchTorrentBytes() async throws {
        ...
        XCTAssertEqual(stats.uploadSpeed, 2_990_000)
    ...
    func testMutationsSurviveRefreshAndNewServerResets() async throws {
        ...
        XCTAssertEqual(stats.downloadSpeed, 64_000)
        XCTAssertEqual(stats.uploadSpeed, 2_260_000)
        ...
        XCTAssertEqual(fresh.first { $0.id == 6 }?.rateDownload, 14_900_000)
        XCTAssertEqual(fresh.first { $0.id == 6 }?.rateUpload, 730_000)
    }
